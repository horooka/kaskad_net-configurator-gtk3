...
class NetworkInteractionConfigurator : public Gtk::Window {
    ...
    protected:
        ...
        bool is_station() {
            ...
            if (!curr_station_row)
                return false;
            return curr_station_row->parent();
        }
        ...
        void on_station_selection_changed() {
            stored_curr_station_row = *treeview.get_selection()->get_selected();
    ...
    private:
        ...
        void setup_signals() {
            ...
            button_make_curr_server.signal_clicked().connect([this]() {
                ...
                if (!model)
                    return;
                Gtk::TreeModel::Children stations = model->children();
            ...
            check_button_proxy.signal_toggled().connect([this]() {
                ...
                if ((stored_curr_station_row[station_cols.proxy_address] ==
                     "Нет") == !check_button_proxy.get_active()) {
